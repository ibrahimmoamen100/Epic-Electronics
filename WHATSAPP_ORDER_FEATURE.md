...
## الوصف
تم إضافة ميزة إرسال تفاصيل الطلب تلقائياً عبر WhatsApp إلى الرقم `01025423389` بعد حفظ الطلب بنجاح في Firebase.

## الميزات

### 📱 إرسال تلقائي للطلبات
- يتم إرسال رسالة WhatsApp تلقائياً بعد حفظ الطلب
- الرقم المستهدف: `01025423389`
...
- ✅ **تشفير URL**: معالجة صحيحة للنص الحمد
